...
The product site lives at **[tomatick.us](https://tomatick.us)** and is built with
**Astro + Tailwind** (source in [`site/`](site/)), deployed to **Cloudflare Pages**.
Privacy-friendly, cookieless [Plausible](https://plausible.thompsonblack.us) analytics;
self-hosted JetBrains Mono; a strict CSP shipped via `site/public/_headers`; and a
Playwright harness that exercises every page under that production CSP.
...
npm run test:harness   # headless-Chromium checks under the real CSP
npm run gen:assets     # regenerate og.png / favicons from the brand SVG
```
...
|-----------|---------|---------|----------|
| [rumps](https://github.com/jaredks/rumps) | ≥0.4 | BSD-3-Clause | menu bar app framework |
| [PyObjC](https://pyobjc.readthedocs.io) | rumps dep | MIT | AppKit / Foundation bindings |
| [py2app](https://py2app.readthedocs.io) | ≥0.28 | MIT | building `Tomatick.app` |
| [Pillow](https://python-pillow.org) | — | HPND (MIT-CMU) | icon generation (`scripts/make_icon.py`) |
| [Astro](https://astro.build) | 4.16 | MIT | tomatick.us site framework |
| [Tailwind CSS](https://tailwindcss.com) | 3.4 | MIT | site styling |
| [JetBrains Mono](https://www.jetbrains.com/lp/mono/) | 2.x | SIL OFL 1.1 | display headings (self-hosted `woff2`) |
| [GitHub Octocat mark](https://github.com/logos) | — | © GitHub, per brand guidelines | GitHub links |
| [Plausible](https://plausible.io) | self-hosted | AGPL-3.0 | privacy-friendly analytics |
| [Playwright](https://playwright.dev) | 1.61 (dev) | Apache-2.0 | CSP test harness |
...
original artwork, generated by [`scripts/make_icon.py`](scripts/make_icon.py). The
website's tomato brand mark / favicon are likewise original.
